...
**KOC+ can also be treated as the variant of Kernel Extreme learning Machine or Least Square SVM with zero bias, therefore, paper and method can also be named as follows:**
